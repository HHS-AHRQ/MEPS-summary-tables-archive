...
data MEPS; set MEPS;
 ...
 OMAEXP03 = VISEXP03 + OTHEXP03;

 TOTUSE03 = 
  ((DVTOT03 > 0) + (RXTOT03 > 0) + (OBTOTV03 > 0) +
...
data FYCsub; set MEPS;
 keep ind DUPERSID PERWT03F VARSTR VARPSU;
run;
...
proc sort data = all_events;
 by ind DUPERSID VARSTR VARPSU PERWT03F Condition event ind count;
run;
