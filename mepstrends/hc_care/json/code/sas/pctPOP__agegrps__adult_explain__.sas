...
proc surveyfreq data = MEPS missing;
  FORMAT adult_explain freq. agegrps agegrps.;
  STRATA VARSTR;
  CLUSTER VARPSU;
  WEIGHT SAQWT&yy.F;
  TABLES domain*agegrps*adult_explain / row;
run;

proc print data = out;
  where domain = 1 and adult_explain ne . and agegrps ne .;
  var adult_explain agegrps WgtFreq StdDev Frequency RowPercent RowStdErr;
run;
