...
proc surveyfreq data = MEPS missing;
  FORMAT diab_a1c diab_a1c. race race.;
  STRATA VARSTR;
  CLUSTER VARPSU;
  WEIGHT DIABW&yy.F;
  TABLES domain*race*diab_a1c / row;
run;

proc print data = out;
  where domain = 1 and diab_a1c ne . and race ne .;
  var diab_a1c race WgtFreq StdDev Frequency RowPercent RowStdErr;
run;
