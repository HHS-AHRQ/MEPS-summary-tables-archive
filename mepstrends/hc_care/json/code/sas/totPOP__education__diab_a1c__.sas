...
proc surveyfreq data = MEPS missing;
  FORMAT diab_a1c diab_a1c. education education.;
  STRATA VARSTR;
  CLUSTER VARPSU;
  WEIGHT DIABW&yy.F;
  TABLES domain*education*diab_a1c / row;
run;

proc print data = out;
  where domain = 1 and diab_a1c ne . and education ne .;
  var diab_a1c education WgtFreq StdDev Frequency RowPercent RowStdErr;
run;
