...
proc surveyfreq data = MEPS missing;
  FORMAT diab_eye diab_eye. insurance insurance.;
  STRATA VARSTR;
  CLUSTER VARPSU;
  WEIGHT DIABW&yy.F;
  TABLES domain*insurance*diab_eye / row;
run;

proc print data = out;
  where domain = 1 and diab_eye ne . and insurance ne .;
  var diab_eye insurance WgtFreq StdDev Frequency RowPercent RowStdErr;
run;
