...
proc surveyfreq data = MEPS missing;
  FORMAT adult_respect freq. education education.;
  STRATA VARSTR;
  CLUSTER VARPSU;
  WEIGHT SAQWT&yy.F;
  TABLES domain*education*adult_respect / row;
run;

proc print data = out;
  where domain = 1 and adult_respect ne . and education ne .;
  var adult_respect education WgtFreq StdDev Frequency RowPercent RowStdErr;
run;
